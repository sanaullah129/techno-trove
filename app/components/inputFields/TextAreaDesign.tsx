...
const TextAreaDesign: React.FC<TextAreaDesignProps> = ({
    id,
    label,
    disabled,
    required,
    ...
    return (
        <div className="w-full relative">
            <textarea
                ...
                placeholder=""
                className={`
                  peer w-full p-4 pt-6 outline-none max-h-[150px] min-h-[100px]
            ...
            <label
                htmlFor={id}
                className={`
                  absolute cursor-text text-md duration-150
